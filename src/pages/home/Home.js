...
function Home() {
  ...
  // Show greeting initially, then hide after 3 seconds
  useEffect(() => {
  ...
  return (
    <div className="home">
      ...
      <div className="goat-character">
        <div className={`goat-greeting ${showGoatGreeting ? 'show-greeting' : ''}`}>
          Welcome to SkillsetAI!
        </div>
        <img src={goatImage} alt="SkillsetAI learning assistant" />
      </div>
